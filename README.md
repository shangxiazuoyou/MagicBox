...
- [LocaleChanger](https://github.com/franmontiel/LocaleChanger) -An Android library to programmatically set the Locale of an app and persist the configuration.
